...
using AvtoMigBussines.Detailing.Controllers;
...
builder.Services.AddScoped<IWhatsappSender, AvtoMigBussines.Detailing.Services.Implementations.WhatsappSenderService>();
builder.Services.AddScoped<IDetailingLiveDashboardRepository, DetailingLiveDashboardRepository>();
builder.Services.AddScoped<IDetailingLiveDashboardService, DetailingLiveDashboardService>();
...
builder.Services.AddSingleton<ILogger, Logger<DetailingOrderController>>();
builder.Services.AddScoped<IMarketingService, MarketingService>();
builder.Services.AddScoped<IMarketingRepository, MarketingRepository>();
builder.Services.AddScoped<AvtoMigBussines.Detailing.Repositories.Interfaces.IClientRepository, AvtoMigBussines.Detailing.Repositories.Implementations.ClientRepository>();
...
builder.WebHost.UseUrls("https://0.0.0.0:7224"); // ��� HTTPS
